...
export function PerBeatVoicingEditor({
  ...
  return (
    <div className="per-beat-voicing-editor bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
      <div className="mb-4">
            ...
            >
              ...
              <div className="flex-1">
                <input
                  ...
                  disabled={practicePadMode}
                  className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
