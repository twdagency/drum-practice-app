...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(50)].map((_, i) => (
            <div
              key={i}
              className="absolute w-1 h-1 bg-white/20 rounded-full floating-element"
              style={{
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p 
              ref={subtitleRef}
              className="text-xl md:text-2xl lg:text-3xl text-white/70 max-w-3xl mx-auto leading-relaxed"
            >
          ...
          >
            {session?.user ? (
              <>
                <Link
                  href="/app"
                  className="group relative px-10 py-5 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-2xl font-bold text-lg transition-all transform hover:scale-110 shadow-2xl shadow-purple-500/50 overflow-hidden"
                >
                ...
                <Link
                  href="/pricing"
                  className="px-10 py-5 bg-white/10 backdrop-blur-xl border-2 border-white/20 text-white rounded-2xl font-bold text-lg transition-all transform hover:scale-105 hover:bg-white/20 hover:border-white/40"
                >
                  View Pricing
                </Link>
              </>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-black mb-6 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
              Powerful Features
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="feature-card group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:border-white/20"
              >
                <div className={`text-5xl mb-6 inline-block p-4 rounded-2xl bg-gradient-to-br ${feature.gradient} opacity-80 group-hover:opacity-100 transition-opacity`}>
                  {feature.icon}
                </div>
      ...
      <section 
        ref={pricingRef}
        className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-purple-900/10 to-black"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-black mb-6 bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={index}
                className={`pricing-card relative ${plan.popular ? 'md:-mt-8 md:mb-8' : ''}`}
              >
      ...
      <section className="relative py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-16 text-center overflow-hidden">
