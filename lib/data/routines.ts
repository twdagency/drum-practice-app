...
export const PRACTICE_ROUTINES: PracticeRoutine[] = [
  ...
  // ============================================
  {
    ...
    name: '40-Minute Rudiment Session',
    description: 'Deep dive into essential rudiments from the PAS 40. Focus on rolls, paradiddles, flams, and drags with progressive tempo increases.',
    category: 'technique',
    difficulty: 'advanced',
    totalDuration: 40,
    icon: 'book-open',
    tags: ['rudiments', 'advanced', 'technique', 'intensive', 'PAS 40'],
    goals: ['Build rudiment vocabulary', 'Improve control at various tempos', 'Develop muscle memory'],
    prerequisites: ['Strong single and double strokes', 'Familiar with basic rudiments'],
    exercises: [
      {
        id: 'rm-1',
        presetId: 'beginner-single-stroke-roll',
        name: 'Single Stroke Roll (#1)',
        duration: 3,
        startBPM: 80,
        targetBPM: 120,
        focusArea: 'Roll Family',
        instructions: 'PAS Rudiment #1. Alternating single strokes - the foundation of all drumming.',
        tips: ['Even stick heights', 'Relaxed grip'],
        restAfter: 15,
      },
      {
        id: 'rm-2',
        presetId: 'intermediate-double-stroke-roll',
        name: 'Double Stroke Roll (#3)',
        duration: 4,
        startBPM: 70,
        targetBPM: 110,
        focusArea: 'Roll Family',
        instructions: 'PAS Rudiment #3. Two strokes per hand - essential for rolls and fills.',
        tips: ['Wrist for slow, fingers for fast', 'Even spacing between doubles'],
        restAfter: 15,
      },
      {
        id: 'rm-3',
        presetId: 'beginner-paradiddle',
        name: 'Single Paradiddle (#17)',
        duration: 4,
        startBPM: 70,
        targetBPM: 100,
        focusArea: 'Paradiddle Family',
        instructions: 'PAS Rudiment #17. RLRR LRLL - accent the first note of each group.',
        tips: ['Accent/tap contrast', 'Keep doubles even'],
        restAfter: 15,
      },
      {
        id: 'rm-4',
        ...
        instructions: 'PAS Rudiment #25. Flam followed by a tap with the same hand.',
        tips: ['Grace note close to main stroke', 'Tap stays low'],
        restAfter: 15,
      },
      {
        id: 'rm-5',
        ...
        targetBPM: 95,
        focusArea: 'Flam Family',
        instructions: 'PAS Rudiment #26. Three-note groups with alternating flams.',
        tips: ['Accent the flammed note', 'Two taps follow'],
        restAfter: 15,
      },
      {
        id: 'rm-6',
        presetId: 'intermediate-flam-paradiddle',
        name: 'Flam Paradiddle (#28)',
        duration: 4,
        startBPM: 60,
        targetBPM: 85,
        focusArea: 'Flam Family',
        instructions: 'PAS Rudiment #28. Flam + paradiddle = powerful combination.',
        tips: ['Flam on beat 1', 'Paradiddle flows from there'],
        restAfter: 15,
      },
      {
        id: 'rm-7',
        ...
        instructions: 'PAS Rudiment #31. Two grace notes (drag) before the main stroke.',
        tips: ['Let sticks bounce for grace notes', 'Main stroke is accented'],
        restAfter: 15,
      },
      {
        id: 'rm-8',
        presetId: 'intermediate-paradiddle-diddle',
        name: 'Paradiddle-Diddle (#20)',
        duration: 4,
        startBPM: 70,
        targetBPM: 100,
        focusArea: 'Paradiddle Family',
        instructions: 'PAS Rudiment #20. RLRRLL - six-note grouping, great for 6/8 and triplet feels.',
        tips: ['Think: para-diddle-diddle', 'Accent beat 1'],
        restAfter: 15,
      },
      {
        id: 'rm-9',
        presetId: 'rudiment-single-ratamacue',
        name: 'Single Ratamacue (#36)',
        duration: 4,
        startBPM: 55,
        targetBPM: 80,
        focusArea: 'Drag Family',
        instructions: 'PAS Rudiment #36. Drag followed by triplet with accent on 1.',
        tips: ['Count: drag-ta-ta-TAH', 'Clear accent on beat 4'],
        restAfter: 15,
      },
      {
        id: 'rm-10',
        presetId: 'intermediate-accent-tap',
        name: 'Accent/Tap Combinations',
        duration: 5,
        startBPM: 75,
        targetBPM: 105,
        focusArea: 'Dynamic Control',
        instructions: 'Apply accent/tap technique to strengthen all rudiment dynamics.',
        tips: ['Maximum height contrast', 'Low = piano, High = forte'],
      },
    ],
  },
  ...
  {
    id: 'flam-focus-15',
    name: '15-Minute Flam Focus',
    description: 'Intensive focus on flam rudiments. Perfect for improving grace note control and dynamic contrast.',
    category: 'technique',
    difficulty: 'intermediate',
    totalDuration: 15,
    icon: 'target',
    tags: ['flams', 'rudiments', 'technique', 'focused'],
    goals: ['Master grace note placement', 'Improve dynamic contrast', 'Build flam vocabulary'],
    prerequisites: ['Basic single strokes', 'Understanding of accent/tap'],
    exercises: [
      {
        id: 'ff-1',
        presetId: 'beginner-single-stroke-eighth',
        ...
        targetBPM: 90,
        focusArea: 'Prep',
        instructions: 'Quick warmup before focusing on flams.',
        restAfter: 15,
      },
      {
        id: 'ff-2',
        ...
        startBPM: 60,
        targetBPM: 90,
        focusArea: 'Basic Flam',
        instructions: 'Focus on consistent grace note distance.',
        tips: ['Grace note should be noticeably softer', 'Different stick heights'],
        restAfter: 15,
      },
      {
        id: 'ff-3',
        ...
        startBPM: 60,
        targetBPM: 85,
        focusArea: 'Dynamic Flam',
        instructions: 'Three-note groups with clear dynamics.',
        tips: ['Accent the flammed note', 'Two soft taps follow'],
        restAfter: 15,
      },
      {
        id: 'ff-4',
        ...
        startBPM: 55,
        targetBPM: 80,
        focusArea: 'Complex Flam',
        instructions: 'Combine flams with paradiddle sticking.',
        tips: ['Start slow', 'Flam on beat 1 only'],
      },
    ],
  },
  ...
  {
    id: 'groove-feel-20',
    name: '20-Minute Groove & Feel',
    description: 'Work on groove, feel, and pocket playing. Less about speed, more about musicality.',
    category: 'genre',
    difficulty: 'intermediate',
    totalDuration: 20,
    icon: 'guitar',
    tags: ['groove', 'feel', 'musicality', 'beats'],
    goals: ['Develop strong time feel', 'Play in the pocket', 'Musical expression'],
    exercises: [
      {
        id: 'gf-1',
        presetId: 'beat-basic-rock',
        ...
        startBPM: 85,
        focusArea: 'Foundation',
        instructions: 'Focus on locking in with the click. No tempo changes - just feel.',
        tips: ['Breathe with the music', 'Relax into the groove'],
        restAfter: 20,
      },
      {
        id: 'gf-2',
        ...
        startBPM: 90,
        focusArea: 'Vocabulary',
        instructions: 'Same groove, different kick patterns. Stay in the pocket.',
        tips: ['Snare stays consistent', 'Kick adds color'],
        restAfter: 20,
      },
      {
        id: 'gf-3',
        presetId: 'beat-funk-basic',
        name: 'Funk Groove',
        duration: 5,
        startBPM: 95,
        focusArea: 'Syncopation',
        instructions: 'Add some funk! Ghost notes and syncopation.',
        tips: ['Ghost notes should whisper', 'Feel the 16th note grid'],
        restAfter: 20,
      },
      {
        id: 'gf-4',
        presetId: 'beat-shuffle',
        name: 'Shuffle Feel',
        duration: 5,
        startBPM: 80,
        focusArea: 'Triplet Feel',
        instructions: 'Swing those 8th notes. Think triplet, play shuffle.',
        tips: ['Bounce the hi-hat', 'Relax into the swing'],
      },
    ],
  },
  ...
  // ============================================
  {
    id: 'daily-maintenance-15',
    name: '15-Minute Daily Maintenance',
    description: 'Quick daily routine to maintain your chops. Perfect for busy days when you still want to touch the drums.',
    category: 'warmup',
    difficulty: 'beginner',
    totalDuration: 15,
    icon: 'zap',
    tags: ['daily', 'maintenance', 'quick', 'essential'],
    goals: ['Maintain technique', 'Stay consistent', 'Quick refresh'],
    exercises: [
      {
        id: 'dm-1',
        presetId: 'beginner-single-stroke-quarter',
        name: 'Singles - Quarters',
        duration: 2,
        startBPM: 60,
        targetBPM: 80,
        focusArea: 'Warmup',
        instructions: 'Start slow, focus on form.',
        restAfter: 10,
      },
      {
        id: 'dm-2',
        presetId: 'beginner-single-stroke-eighth',
        name: 'Singles - Eighths',
        duration: 2,
        startBPM: 70,
        targetBPM: 100,
        focusArea: 'Speed',
        instructions: 'Push the tempo a bit.',
        restAfter: 10,
      },
      {
        id: 'dm-3',
        ...
        targetBPM: 80,
        focusArea: 'Control',
        instructions: 'Even doubles, good bounce.',
        restAfter: 10,
      },
      {
        id: 'dm-4',
        ...
        targetBPM: 90,
        focusArea: 'Coordination',
        instructions: 'RLRR LRLL with accents.',
        restAfter: 10,
      },
      {
        id: 'dm-5',
        ...
        targetBPM: 90,
        focusArea: 'Dynamics',
        instructions: 'Big difference between accents and taps.',
        restAfter: 10,
      },
      {
        id: 'dm-6',
        ...
        startBPM: 100,
        focusArea: 'Musical',
        instructions: 'End with some music. Feel good!',
      },
    ],
  },
];
